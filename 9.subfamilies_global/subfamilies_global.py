...
# =============================================================================
from subfamilies_global_functions import blastn_dic, blastn_blaster, fasta_creator, save_sequences_to_csv_pandas, find_maximal_sets, count_sequences

# =============================================================================
# Main action
# =============================================================================
def grouping_subfamily(input_data, output_path):
    repeated_chr = []
...
if __name__ == "__main__":
    ...
    grouping_subfamily(data_grouped, path_out)